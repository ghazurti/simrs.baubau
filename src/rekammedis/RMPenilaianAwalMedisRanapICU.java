 ...
 * @author perpustakaan
 */
public final class RMPenilaianAwalMedisRanapICU extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMPenilaianAwalMedisRanapICU(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        
        tabMode=new DefaultTableModel(null,new Object[]{
            "No.Rawat","No.RM","Nama Pasien","Tgl.Lahir","J.K.","Kode Dokter","Nama Dokter","Tanggal","Anamnesis","Hubungan","Subjective","B1 Breathing","B2 Blood",
            "B3 Brain","B4 Bladder","Riwayat Alergi","Nyeri","On Set","On Set","Skala Nyeri","Gambaran Nyeri","Durasi Nyeri","Suhu","SpO2","Frekuensi Nyeri","Lokasi Nyeri","Kepala",
            "Mata","Gigi & Mulut","THT","Thoraks","Jantung","Paru","Abdomen","Genital & Anus","Ekstremitas","Kulit","B5 Bowel","B6 Bone","Laboratorium","X-Ray",
            "Elektrokardiogram","Diagnosis Kerja","Planning","Lain Lain"
        }){
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Penilaian Awal Medis ICU ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        jLabel9.setText("B2 (Blood) :");
        jLabel9.setName("jLabel9"); // NOI18N
        FormInput.add(jLabel9);
        jLabel9.setBounds(20, 320, 120, 23);
        ...
        jLabel12.setBounds(70, 650, 60, 23);
        ...
        FormInput.add(BB);
        BB.setBounds(140, 650, 340, 23);

        jLabel13.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel13.setText("Kg");
        jLabel13.setName("jLabel13"); // NOI18N
        FormInput.add(jLabel13);
        jLabel13.setBounds(700, 1580, 30, 23);
        ...
        FormInput.add(TB);
        TB.setBounds(140, 620, 340, 23);

        jLabel15.setText("Lokasi Nyeri :");
        jLabel15.setName("jLabel15"); // NOI18N
        FormInput.add(jLabel15);
        jLabel15.setBounds(60, 620, 70, 23);

        jLabel16.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel16.setText("x/menit");
        jLabel16.setName("jLabel16"); // NOI18N
        FormInput.add(jLabel16);
        jLabel16.setBounds(220, 1610, 50, 23);
        ...
        FormInput.add(Nadi);
        Nadi.setBounds(140, 530, 340, 23);

        jLabel17.setText("Gambaran Nyeri :");
        jLabel17.setName("jLabel17"); // NOI18N
        FormInput.add(jLabel17);
        jLabel17.setBounds(40, 530, 90, 23);

        jLabel18.setText("Suhu :");
        jLabel18.setName("jLabel18"); // NOI18N
        FormInput.add(jLabel18);
        jLabel18.setBounds(460, 1610, 40, 23);
        ...
        FormInput.add(Suhu);
        Suhu.setBounds(500, 1610, 45, 23);

        jLabel22.setText("Skala Nyeri :");
        jLabel22.setName("jLabel22"); // NOI18N
        FormInput.add(jLabel22);
        jLabel22.setBounds(10, 500, 110, 23);
        ...
        FormInput.add(TD);
        TD.setBounds(140, 500, 340, 23);

        jLabel20.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel20.setText("°C");
        jLabel20.setName("jLabel20"); // NOI18N
        FormInput.add(jLabel20);
        jLabel20.setBounds(550, 1610, 30, 23);

        jLabel23.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel23.setText("mmHg");
        jLabel23.setName("jLabel23"); // NOI18N
        FormInput.add(jLabel23);
        jLabel23.setBounds(60, 1610, 50, 23);

        jLabel24.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel24.setText(" cm");
        jLabel24.setName("jLabel24"); // NOI18N
        FormInput.add(jLabel24);
        jLabel24.setBounds(570, 1580, 30, 23);

        jLabel25.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel25.setText("x/menit");
        jLabel25.setName("jLabel25"); // NOI18N
        FormInput.add(jLabel25);
        jLabel25.setBounds(380, 1610, 50, 23);
        ...
        FormInput.add(RR);
        RR.setBounds(140, 560, 340, 23);

        jLabel26.setText("Durasi :");
        jLabel26.setName("jLabel26"); // NOI18N
        FormInput.add(jLabel26);
        jLabel26.setBounds(90, 560, 40, 23);

        jLabel37.setText("Riwayat Alergi :");
        jLabel37.setName("jLabel37"); // NOI18N
        FormInput.add(jLabel37);
        jLabel37.setBounds(530, 1710, 150, 23);
        ...
        Alergi.setBounds(680, 1710, 260, 23);
        ...
        scrollPane1.setBounds(150, 100, 720, 100);

        jLabel30.setText("B3 (Brain) :");
        jLabel30.setName("jLabel30"); // NOI18N
        FormInput.add(jLabel30);
        jLabel30.setBounds(80, 390, 60, 23);
        ...
        scrollPane2.setBounds(150, 370, 310, 60);

        jLabel31.setText("B5 (Bowel) :");
        jLabel31.setName("jLabel31"); // NOI18N
        FormInput.add(jLabel31);
        jLabel31.setBounds(460, 320, 70, 23);
        ...
        scrollPane3.setBounds(150, 300, 310, 60);

        jLabel32.setText("B1 (Breathing) :");
        jLabel32.setName("jLabel32"); // NOI18N
        FormInput.add(jLabel32);
        jLabel32.setBounds(20, 260, 120, 23);
        ...
        scrollPane4.setBounds(540, 220, 330, 60);
        ...
        scrollPane5.setBounds(540, 290, 330, 60);

        jLabel28.setText("Pencetus :");
        jLabel28.setName("jLabel28"); // NOI18N
        FormInput.add(jLabel28);
        jLabel28.setBounds(60, 590, 70, 23);
        ...
        FormInput.add(GCS);
        GCS.setBounds(140, 590, 340, 23);

        jLabel94.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel94.setText("Penilaian Nyeri");
        jLabel94.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel94.setName("jLabel94"); // NOI18N
        FormInput.add(jLabel94);
        jLabel94.setBounds(20, 450, 180, 23);
        ...
        jLabel33.setText("B6 (Bone) :");
        jLabel33.setName("jLabel33"); // NOI18N
        FormInput.add(jLabel33);
        jLabel33.setBounds(410, 390, 125, 23);
        ...
        scrollPane7.setBounds(150, 220, 310, 70);

        jLabel39.setText("On Set :");
        jLabel39.setName("jLabel39"); // NOI18N
        FormInput.add(jLabel39);
        jLabel39.setBounds(270, 470, 70, 23);

        Keadaan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Ya", "Tidak" }));
        ...
        Keadaan.setBounds(140, 470, 118, 23);

        jLabel40.setText("Kepala :");
        jLabel40.setName("jLabel40"); // NOI18N
        FormInput.add(jLabel40);
        jLabel40.setBounds(40, 1660, 127, 23);

        Kesadaran.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Akut", "Kronis" }));
        ...
        Kesadaran.setBounds(350, 470, 130, 23);

        jLabel41.setText("Nyeri :");
        jLabel41.setName("jLabel41"); // NOI18N
        FormInput.add(jLabel41);
        jLabel41.setBounds(10, 470, 127, 23);

        jLabel29.setText("SpO2 :");
        jLabel29.setName("jLabel29"); // NOI18N
        FormInput.add(jLabel29);
        jLabel29.setBounds(600, 1610, 40, 23);
        ...
        FormInput.add(SPO);
        SPO.setBounds(650, 1610, 45, 23);

        jLabel35.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel35.setText("%");
        jLabel35.setName("jLabel35"); // NOI18N
        FormInput.add(jLabel35);
        jLabel35.setBounds(700, 1610, 30, 23);
        ...
        Kepala.setBounds(170, 1660, 128, 23);

        jLabel44.setText("Gigi & Mulut :");
        jLabel44.setName("jLabel44"); // NOI18N
        FormInput.add(jLabel44);
        jLabel44.setBounds(40, 1720, 127, 23);
        ...
        FormInput.add(Gigi);
        Gigi.setBounds(170, 1720, 128, 23);

        jLabel45.setText("THT :");
        jLabel45.setName("jLabel45"); // NOI18N
        FormInput.add(jLabel45);
        jLabel45.setBounds(40, 1750, 127, 23);
        ...
        FormInput.add(THT);
        THT.setBounds(170, 1750, 128, 23);

        jLabel46.setText("Thoraks :");
        jLabel46.setName("jLabel46"); // NOI18N
        FormInput.add(jLabel46);
        jLabel46.setBounds(40, 1780, 127, 23);
        ...
        Thoraks.setBounds(170, 1780, 128, 23);

        jLabel49.setText("Abdomen :");
        jLabel49.setName("jLabel49"); // NOI18N
        FormInput.add(jLabel49);
        jLabel49.setBounds(300, 1690, 95, 23);
        ...
        Abdomen.setBounds(400, 1690, 128, 23);

        jLabel50.setText("Genital & Anus :");
        jLabel50.setName("jLabel50"); // NOI18N
        FormInput.add(jLabel50);
        jLabel50.setBounds(300, 1720, 95, 23);
        ...
        Genital.setBounds(400, 1720, 128, 23);

        jLabel51.setText("Ekstremitas :");
        jLabel51.setName("jLabel51"); // NOI18N
        FormInput.add(jLabel51);
        jLabel51.setBounds(300, 1750, 95, 23);
        ...
        Ekstremitas.setBounds(400, 1750, 128, 23);

        jLabel52.setText("Kulit :");
        jLabel52.setName("jLabel52"); // NOI18N
        FormInput.add(jLabel52);
        jLabel52.setBounds(300, 1780, 95, 23);
        ...
        FormInput.add(Kulit);
        Kulit.setBounds(400, 1780, 128, 23);
        ...
        jSeparator13.setBounds(0, 441, 880, 3);
        ...
        scrollPane8.setBounds(540, 360, 330, 70);

        jLabel79.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel79.setText("Subjective :");
        jLabel79.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel79.setName("jLabel79"); // NOI18N
        FormInput.add(jLabel79);
        jLabel79.setBounds(20, 80, 100, 23);

        jLabel100.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel100.setText("Objective :");
        jLabel100.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel100.setName("jLabel100"); // NOI18N
        FormInput.add(jLabel100);
        jLabel100.setBounds(20, 220, 180, 23);
        ...
        scrollPane9.setBounds(50, 740, 260, 63);

        jLabel101.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel101.setText("PEMERIKSAAN PENUNJANG");
        jLabel101.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel101.setName("jLabel101"); // NOI18N
        FormInput.add(jLabel101);
        jLabel101.setBounds(20, 700, 190, 23);
        ...
        scrollPane12.setBounds(50, 830, 810, 43);

        jLabel102.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel102.setText("Diagnosa Kerja/Diagnosa Banding");
        jLabel102.setName("jLabel102"); // NOI18N
        FormInput.add(jLabel102);
        jLabel102.setBounds(20, 810, 190, 23);
        ...
        scrollPane13.setBounds(50, 900, 810, 153);

        jLabel103.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel103.setText("Planning");
        jLabel103.setName("jLabel103"); // NOI18N
        FormInput.add(jLabel103);
        jLabel103.setBounds(20, 880, 190, 23);
        ...
        scrollPane14.setBounds(50, 1080, 810, 63);
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "07-12-2023 22:06:42" }));
        ...
        jLabel104.setText("Lain - Lain");
        jLabel104.setName("jLabel104"); // NOI18N
        FormInput.add(jLabel104);
        jLabel104.setBounds(20, 1060, 190, 23);

        jLabel42.setText("Mata :");
        jLabel42.setName("jLabel42"); // NOI18N
        FormInput.add(jLabel42);
        jLabel42.setBounds(40, 1690, 127, 23);
        ...
        FormInput.add(Mata);
        Mata.setBounds(170, 1690, 128, 23);

        jLabel47.setText("Jantung :");
        jLabel47.setName("jLabel47"); // NOI18N
        FormInput.add(jLabel47);
        jLabel47.setBounds(40, 1810, 127, 23);
        ...
        Jantung.setBounds(170, 1810, 128, 23);

        jLabel53.setText("Paru :");
        jLabel53.setName("jLabel53"); // NOI18N
        FormInput.add(jLabel53);
        jLabel53.setBounds(300, 1660, 95, 23);
        ...
        FormInput.add(Paru);
        Paru.setBounds(400, 1660, 128, 23);

        jLabel80.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel80.setText("Laboratorium :");
        jLabel80.setName("jLabel80"); // NOI18N
        FormInput.add(jLabel80);
        jLabel80.setBounds(50, 720, 150, 23);

        jLabel81.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel81.setText("X-Ray :");
        jLabel81.setName("jLabel81"); // NOI18N
        FormInput.add(jLabel81);
        jLabel81.setBounds(330, 720, 150, 23);
        ...
        scrollPane10.setBounds(330, 740, 260, 63);

        jLabel82.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel82.setText("Elektrokardiogram :");
        jLabel82.setName("jLabel82"); // NOI18N
        FormInput.add(jLabel82);
        jLabel82.setBounds(600, 720, 150, 23);
        ...
        scrollPane11.setBounds(600, 740, 260, 63);

        jLabel34.setText("B4 (Bladder) :");
        jLabel34.setName("jLabel34"); // NOI18N
        FormInput.add(jLabel34);
        jLabel34.setBounds(460, 250, 70, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("penilaian_medis_ranap_icu","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",40,new String[]{
            ...
            try{
                if(TCari.getText().trim().equals("")){
                    ps=koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,penilaian_medis_ranap_icu.tanggal,"+
                        "penilaian_medis_ranap_icu.kd_dokter,penilaian_medis_ranap_icu.anamnesis,penilaian_medis_ranap_icu.hubungan,penilaian_medis_ranap_icu.keluhan_utama,penilaian_medis_ranap_icu.rps,penilaian_medis_ranap_icu.rpk,penilaian_medis_ranap_icu.rpd,penilaian_medis_ranap_icu.rpo,penilaian_medis_ranap_icu.alergi,"+
                        "penilaian_medis_ranap_icu.keadaan,penilaian_medis_ranap_icu.gcs,penilaian_medis_ranap_icu.kesadaran,penilaian_medis_ranap_icu.td,penilaian_medis_ranap_icu.nadi,penilaian_medis_ranap_icu.rr,penilaian_medis_ranap_icu.suhu,penilaian_medis_ranap_icu.spo,penilaian_medis_ranap_icu.bb,penilaian_medis_ranap_icu.tb,"+
                        "penilaian_medis_ranap_icu.kepala,penilaian_medis_ranap_icu.mata,penilaian_medis_ranap_icu.gigi,penilaian_medis_ranap_icu.tht,penilaian_medis_ranap_icu.thoraks,penilaian_medis_ranap_icu.jantung,penilaian_medis_ranap_icu.paru,penilaian_medis_ranap_icu.abdomen,penilaian_medis_ranap_icu.ekstremitas,"+
                        "penilaian_medis_ranap_icu.genital,penilaian_medis_ranap_icu.kulit,penilaian_medis_ranap_icu.ket_fisik,penilaian_medis_ranap_icu.ket_lokalis,penilaian_medis_ranap_icu.lab,penilaian_medis_ranap_icu.rad,penilaian_medis_ranap_icu.penunjang,penilaian_medis_ranap_icu.diagnosis,penilaian_medis_ranap_icu.tata,"+
                        "penilaian_medis_ranap_icu.edukasi,dokter.nm_dokter "+
                        "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                        "inner join penilaian_medis_ranap_icu on reg_periksa.no_rawat=penilaian_medis_ranap_icu.no_rawat "+
                        "inner join dokter on penilaian_medis_ranap_icu.kd_dokter=dokter.kd_dokter where "+
                        "penilaian_medis_ranap_icu.tanggal between ? and ? order by penilaian_medis_ranap_icu.tanggal");
                }else{
                    ps=koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,penilaian_medis_ranap_icu.tanggal,"+
                        "penilaian_medis_ranap_icu.kd_dokter,penilaian_medis_ranap_icu.anamnesis,penilaian_medis_ranap_icu.hubungan,penilaian_medis_ranap_icu.keluhan_utama,penilaian_medis_ranap_icu.rps,penilaian_medis_ranap_icu.rpk,penilaian_medis_ranap_icu.rpd,penilaian_medis_ranap_icu.rpo,penilaian_medis_ranap_icu.alergi,"+
                        ...
                        "inner join penilaian_medis_ranap_icu on reg_periksa.no_rawat=penilaian_medis_ranap_icu.no_rawat "+
                        "inner join dokter on penilaian_medis_ranap_icu.kd_dokter=dokter.kd_dokter where "+
                        "penilaian_medis_ranap_icu.tanggal between ? and ? and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or "+
                        "penilaian_medis_ranap_icu.kd_dokter like ? or dokter.nm_dokter like ?) order by penilaian_medis_ranap_icu.tanggal");
                }
                ...
                try {
                    ...
                    htmlContent.append(                             
                        "<tr class='isi'>"+
                            ...
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='300px'><b>Subjective</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='150px'><b>B1 Breathing</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='150px'><b>B2 Blood</b></td>"+
			    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='150px'><b>B3 Brain</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='150px'><b>B4 Baldder</b></td>"+
//                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='120px'><b>Riwayat Alergi</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='90px'><b>Nyeri</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='50px'><b>Pencetus</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='80px'><b>On Set</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='60px'><b>Skala Nyeri</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='75px'><b>Gambaran Nyeri</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='67px'><b>Durasi Nyeri</b></td>"+
...
//                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='40px'><b>SpO2</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='40px'><b>Frekuensi Nyeri</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='40px'><b>Lokasi Nyeri</b></td>"+
...
//                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='80px'><b>Kulit</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='300px'><b>B5 Bowel</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='200px'><b>B6 Bone</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='170px'><b>Laboratorium</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='170px'><b>X-Ray</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='170px'><b>Elektrokardiogram</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='150px'><b>Diagnosis Kerja</b></td>"+
			    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='300px'><b>Planning</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='150px'><b>Lain Lain</b></td>"+
                        "</tr>"
                    );
                    while(rs.next()){
                        htmlContent.append(
...
//                               "<td valign='top'>"+rs.getString("kulit")+"</td>"+
                    ...
                    File f = new File("DataPenilaianAwalMedisICU.html");            
                                ...
                                "<table width='4600px' border='0' align='center' cellpadding='3px' cellspacing='0' class='tbl_form'>"+
                                    "<tr class='isi2'>"+
                                        "<td valign='top' align='center'>"+
                                            ...
                                            "<font size='2' face='Tahoma'>ASESMEN AWAL MEDIS KHUSUS ICU<br><br></font>"+        
                                        "</td>"+
                                   "</tr>"+
                                "</table>")
                    );
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportqry("rptCetakPenilaianAwalMedisRanap.jasper","report","::[ Laporan Penilaian Awal Medis Rawat Inap ]::",
                ...
                "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                "inner join penilaian_medis_ranap_icu on reg_periksa.no_rawat=penilaian_medis_ranap_icu.no_rawat "+
                "inner join dokter on penilaian_medis_ranap_icu.kd_dokter=dokter.kd_dokter where penilaian_medis_ranap_icu.no_rawat='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"'",param);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMPenilaianAwalMedisRanapICU dialog = new RMPenilaianAwalMedisRanapICU(new javax.swing.JFrame(), true);
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from penilaian_medis_ranap_icu where no_rawat=?",1,new String[]{
    ...
    private void ganti() {
        if(Sequel.mengedittf("penilaian_medis_ranap_icu","no_rawat=?","no_rawat=?,tanggal=?,kd_dokter=?,anamnesis=?,hubungan=?,keluhan_utama=?,rps=?,rpk=?,rpd=?,rpo=?,alergi=?,keadaan=?,gcs=?,kesadaran=?,td=?,nadi=?,rr=?,suhu=?,"+
